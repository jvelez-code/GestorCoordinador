...
export class ReporteAgendaComponent {
  ...
  displayedColumns: string[] = ['id_campana', 'fecha_hora_sis', 'fecha_agenda', 'tipo_documento','nro_documento', 
                                'razon_social', 'obsagenda', 'usuario', 'hora_agenda','fecha_gestion', 'hora_gestion', 'obsgestionada', 'diferenciadias',];
  ...
  ngOnInit(): void {
    ...
    aceptar(){    
     ...
     //parametros son los paramatros que enviamos y node.js los toma en el header
      ...
      this.reporteService.reporReporteAgenda(parametros).subscribe(data=>{
