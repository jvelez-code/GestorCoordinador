...
export class ExcelPorcentajeDeTipificacionService {
  ...
  async porcentajeportipificacion(dataExcel: ReportesGeneral[], parametros: any): Promise<void> {
  ...
  private crearPorcentanjeDeTipificacion(dataExcelTable: ReportesGeneral[], parametros: any): void {
