...
export class ExcelIvrService {
  ...
  private crearIvr(dataExcelTable: ReportesGeneral[], parametros: any): void {
    ...
    const sheet = this._worbook.addWorksheet(`REPORTE IVR ${empresa}`);
   ...
   sheet.mergeCells("H10000:BD1"); //combina las celdas para dejar el espacio blanco a la derecha
    ...
    sheet.getCell("A1").value = `REPORTE IVR ${empresa}`;
