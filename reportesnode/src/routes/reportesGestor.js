...
router.post('/detalleGestionesUsuarios', ReporGestor.postDetalleGestionesUsuario);
...
router.post('/ControlVisitasUsuarios', ReporGestor.postVisitaComercialUsuario);
router.post('/registrosnuevos', ReporGestor.postFidelizacionComercial);
router.post('/registrosNuevosUsuarios', ReporGestor.postFidelizacionUsuario);
router.post('/porcentaje', ReporGestor.postPorcentajeTipificacion);
router.post('/menus', ReporGestor.postMenus);
router.post('/seguimiento', ReporGestor.postSeguimientoAgente);

//CRM
router.post('/reporteCasos', ReporGestor.postReporteCasos );
